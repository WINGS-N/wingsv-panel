<template>
  ...
  <section v-if="trust && trust.classes.length" class="surface-card mt-6">
    ...
    <p class="admin-muted mt-1">
      Считается и форма поведения (сколько адресов, откуда, какие порты), и то, куда шли соединения: по одним счётчикам
      мошенничество от обычной жизни не отличить. Наблюдения живут месяц и наружу не уходят.
    </p>
