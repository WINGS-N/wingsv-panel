...
// Сколько выдано, и всё. Сколько человеку "положено по доверию" - это наша
// внутренняя арифметика, ему от неё ни тепло ни холодно
const nodesMeta = computed(() => 'выдано сейчас');
